...
const modelCapabilities: Record<string, ModelCap> = {
  ...
  'phi4': { context: 16 },
  // 百炼 Coding Plan 模型
  'qwen3.6-plus': { vision: true, thinking: true, context: 1000 },
  'qwen3.6-flash': { vision: true, context: 1000 },
  'qwen3-coder-plus': { thinking: true, context: 1000 },
  'kimi-k2.7-code': { vision: true, context: 262 },
  'kimi-k2.6': { vision: true, context: 262 },
  'kimi-k2.5': { vision: true, context: 262 },
  'glm-5.2': { thinking: true, context: 1000 },
  'glm-5.1': { context: 202 },
  'glm-5': { context: 202 },
  'glm-4.7': { context: 202 },
  'glm-latest': { thinking: true, context: 1000 },
  'MiniMax-M2.5': { context: 204 },
  // 方舟 Coding Plan 模型
  'ark-code-latest': { vision: true, thinking: true, context: 256 },
  'doubao-seed-2.0-code': { thinking: true, context: 256 },
  'minimax-m3': { vision: true, thinking: true, context: 1000 },
  'deepseek-v4-pro': { thinking: true, context: 163 },
  'deepseek-v4-flash': { context: 163 },
  'deepseek-v3.2': { context: 163 },
  'deepseek-ai/DeepSeek-V3': { context: 64 },
...
const providerPresets = [
  ...
  { id: 'qwen', label: '通义千问', desc: 'Qwen3.7 百炼 Coding Plan (OpenAI 兼容)', color: 'linear-gradient(135deg, #615ced, #4a45c4)', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', models: ['qwen3.7-plus', 'qwen3.7-max', 'qwen3.6-plus', 'qwen3.6-flash', 'qwen3-max', 'qwen3-plus', 'qwen3-turbo', 'qwen3-coder-plus'] },
  { id: 'qwen-coding', label: '百炼 Coding', desc: '百炼 Coding Plan (Anthropic 兼容)', color: 'linear-gradient(135deg, #615ced, #4a45c4)', baseUrl: 'https://coding.dashscope.aliyuncs.com/apps/anthropic', models: ['qwen3.7-plus', 'qwen3.6-plus', 'qwen3-coder-plus', 'kimi-k2.7-code', 'kimi-k2.6', 'glm-5', 'glm-4.7', 'MiniMax-M2.5'] },
  { id: 'zhipu', label: '智谱 GLM', desc: 'GLM-5.2 Coding Plan (Anthropic 兼容)', color: 'linear-gradient(135deg, #3b6cff, #2b54cc)', baseUrl: 'https://open.bigmodel.cn/api/coding/paas/v4', models: ['glm-5.2', 'glm-5.1', 'glm-5', 'glm-4.7', 'glm-latest'] },
  ...
  { id: 'doubao', label: '豆包/方舟', desc: 'Coding Plan: DeepSeek-V4/Kimi-K2.7/GLM-5.2/M3', color: 'linear-gradient(135deg, #3370ff, #1f5ce6)', baseUrl: 'https://ark.cn-beijing.volces.com/api/coding/v3', models: ['ark-code-latest', 'doubao-seed-2.0-code', 'doubao-seed-2.0-pro', 'minimax-m3', 'glm-5.2', 'deepseek-v4-pro', 'deepseek-v4-flash', 'kimi-k2.7-code', 'kimi-k2.6'] },
  ...
  { id: 'minimax', label: 'MiniMax', desc: 'M3 多模态 1M (OpenAI/Anthropic 兼容)', color: 'linear-gradient(135deg, #ff6b35, #e05520)', baseUrl: 'https://api.minimaxi.com/v1', models: ['MiniMax-M3', 'MiniMax-M2.5'] },
